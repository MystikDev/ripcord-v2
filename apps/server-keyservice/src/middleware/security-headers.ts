...
/**
 * Helmet middleware configured with strict security defaults for the key service.
 *
 ...
 * distributed tracing, and sets Cache-Control: no-store on all
...
export function securityHeaders(req: Request, res: Response, next: NextFunction): void {
  ...
  // Key service responses must never be cached
