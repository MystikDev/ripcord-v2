...
/// The main orchestrator. Wires together window, webview, and IPC.
pub struct Engine {
            ...
            Arc::new(move |params: serde_json::Value| {
                ...
                if visible {
                    if let Some(h) = *hwnd_ref.lock().unwrap() {
                        ...
                        // Make semi-transparent so it's visible for testing
            ...
            for event in win_rx {
                match event {
                    ...
                    WindowEvent::Resized(w, h) => {
                        ...
                        // Sync overlay position to main window
                    ...
                    WindowEvent::Tray(tray_event) => {
                        match tray_event {
                            ...
                            TrayEvent::Mute => {
                                ...
                                // Will be wired to audio engine in Phase 3
                            }
                            TrayEvent::Deafen => {
